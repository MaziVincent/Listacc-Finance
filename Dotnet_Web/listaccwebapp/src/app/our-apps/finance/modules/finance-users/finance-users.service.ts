...
import { DepartmentViewModel } from '../../models/department';
...
@Injectable()
export class FinanceUsersService {

    private usersBase = environment.FinanceUrl + 'user';
    private departmentsBase = environment.FinanceUrl + 'dept';
