...
function windowLoadInit() {
	...
	if ($().flexslider) {
		...
		$introSlider.each(function(index){
			...
			var speed = (data.speed !== 'undefined') ? data.speed : 1000;
	...
	if ($().owlCarousel) {
		$('.owl-carousel').each(function() {
			...
			var loop = data.loop ? data.loop : false,
				...
				navPrev = data.navPrev ? data.navPrev : '<i class="fal fa-angle-left fa-2x">',
				navNext = data.navNext ? data.navNext : '<i class="fal fa-angle-right fa-2x">',
